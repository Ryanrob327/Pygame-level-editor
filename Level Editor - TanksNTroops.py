...
#images
save_img = pygame.image.load('Pygame-level-editor/save_btn.png').convert_alpha()
load_img = pygame.image.load('Pygame-level-editor/load_btn.png').convert_alpha()
#import tile list
img_list = []
for x in range(tile_types):
    img = pygame.image.load(f'Pygame-level-editor/Tileset - TanksNTroops/{x}.png').convert_alpha()
...
while run:
    ...
    pygame.draw.rect(screen, light_blue, (screen_width + 1, 0, side_margin, screen_height + 1))
    pygame.draw.rect(screen, light_blue, (0, screen_height + 1, screen_width + side_margin, lower_margin))
    ...
    if save_button.draw(screen):
        with open(f'Pygame-level-editor/Levels - TanksNTroops/level{level}_data_TNT.csv', 'w', newline='') as csvfile:
    ...
    if load_button.draw(screen):
        x_scroll = 0
        y_scroll = 0
        with open(f'Pygame-level-editor/Levels - TanksNTroops/level{level}_data_TNT.csv', newline='') as csvfile:
